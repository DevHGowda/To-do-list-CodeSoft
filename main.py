...
class MyGUI(QMainWindow):
    ...
    def add_todo(self):
        todo, confiremed = QInputDialog.getText(self, "Add Todo", "New Todo:", QLineEdit.Normal, "")

        if confiremed and not todo.isspace():
    ...
    def open_file(self):
        ...
        filename, _ = QFileDialog.getOpenFileNames(self, "Open File", "", "Todo Files (*.todo)", options=options)
        if filename != "":
